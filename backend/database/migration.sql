...
-- -------------------------------------------------------
-- 5c. pricing_rules - Quy tac dieu chinh gia phong theo mua va ngay le.
-- Moi dong gom pham vi ap dung (ca khach san hoac 1 loai phong), khoang ngay
-- (co dinh hoac lap lai hang nam), loc theo thu trong tuan, muc dieu chinh
-- tren base_price (phan tram hoac so tien, co dau - am la giam gia, duong la
-- phu thu) va do uu tien khi nhieu quy tac cung khop mot ngay.
-- Gia mot dem tinh theo thu tu: room_type_rates, roi quy tac, roi base_price.
-- -------------------------------------------------------
...
-- Quy tac gia theo mua: bo giai gia luon nap quy tac dang bat cua 1 khach san
